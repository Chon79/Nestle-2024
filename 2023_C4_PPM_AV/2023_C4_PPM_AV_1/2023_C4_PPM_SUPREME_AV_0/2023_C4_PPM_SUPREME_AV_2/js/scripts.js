...
btn_prev.addEventListener("click",() => {  
    jumptoSlide('2023_C4_PPM_SUPREME_AV_1.zip', 'PPMA');
});
...
let btn_popup4 = document.querySelector(".btn-popup4");
btn_popup4.addEventListener("click", () => {
    let popup = document.querySelector(".popup-container");
    popup.style.display = 'block';
    popup.classList.add('img-popup4','animate__zoomIn');
});
