...
btn_prev.addEventListener("click",() => {  
    // window.location.href = "../NIDAL-1-2023-c4/index.html";
    jumptoSlide('2023_C4_AFF_NIDAL_AV_1.zip','AFF');
});
let btn_next = document.querySelector(".btn-next");
btn_next.addEventListener("click",() => {
    // window.location.href = "../../OPTIMAL-2023-c4/index.html";
    ...
    $("#mainWrapper").swipe({
        ...
        swipe: async function(event, direction, distance, duration, fingerCount, fingerData) {
            if (direction == 'left') { // avanza
                // window.location.href = "../OPTIMALPRO-2023-c4/index.html";
                jumptoSlide('2023_C4_AFF_OPTIMAL_AV.zip','AFF');
                
            } else if (direction == 'right') { // retrosede
                // window.location.href = "../NIDAL1-2023-c4/index.html";
                jumptoSlide('2023_C4_AFF_NIDAL_AV_1.zip','AFF');
            }
        },
        threshold: 75,
